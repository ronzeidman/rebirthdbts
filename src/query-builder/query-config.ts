...
export const termConfig: TermConfig[] = [
  ...
  [TermType.BETWEEN, 'between', 2, 3, true],
  ...
  [TermType.EQ_JOIN, 'eqJoin', 2, 3, true],
  ...
  [TermType.UPDATE, 'update', 1, 2, true],
  [TermType.DELETE, 'delete', 0, 1, true],
  [TermType.REPLACE, 'replace', 1, 2, true],
  [TermType.INSERT, 'insert', 1, 2, true],
  ...
  [TermType.WAIT, 'wait', 0, 1, true],
  [TermType.RECONFIGURE, 'reconfigure', 0, 1, true],
  [TermType.REBALANCE, 'rebalance', 0, 0, false],
  [TermType.SYNC, 'sync', 0, 0, false],
  [TermType.GRANT, 'grant', 2, 2, false],
  [TermType.INDEX_CREATE, 'indexCreate', 1, 3, true],
  ...
  [TermType.INDEX_RENAME, 'indexRename', 2, 3, true],
  ...
  [TermType.DURING, 'during', 2, 3, true],
  ...
  [TermType.DISTANCE, 'distance', 1, 2, true],
  [TermType.INTERSECTS, 'intersects', 1, 1, false],
  [TermType.INCLUDES, 'includes', 1, 1, false],
  [TermType.GET_INTERSECTING, 'getIntersecting', 2, 2, true],

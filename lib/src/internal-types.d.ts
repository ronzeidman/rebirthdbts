...
export interface ComplexTermJson extends Array<Term.TermType | TermJson[] | OptargsJson> {
    0: Term.TermType;
    1?: TermJson[];
    2?: OptargsJson;
}
export interface QueryJson extends Array<Query.QueryType | TermJson | OptargsJson> {
    0: Query.QueryType;
    1?: TermJson;
    2?: OptargsJson;
}

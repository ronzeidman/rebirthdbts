...
exports.r.deserialize = (termStr) => query_1.toQuery(validateTerm(JSON.parse(termStr)));
...
function validateTerm(term) {
    if (util_1.isUndefined(term)) {
        throw new error_1.RebirthDBError(`Invalid term:\n${JSON.stringify(term)}\n`);
    }
    ...
    if (typeof term === 'object') {
        if (Array.isArray(term)) {
            ...
            if (typeof func !== 'number' || util_1.isUndefined(enums_1.TermType[func])) {
                throw new error_1.RebirthDBError(`Invalid term:\n${JSON.stringify(term)}\n`);
            }
            if (!util_1.isUndefined(args)) {
